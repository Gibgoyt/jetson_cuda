...
INetworkDefinition* createResNet18_2D_513x257Network(
	...
	// Softargmax.
	auto softargmax = addSoftargmax(
	    plugin_factory,
	    *network,
	    *cost_vol->getOutput(0),
	    SoftargmaxType::kMax,
	    data_type,
	    "softargmax_softargmax"
	);
	...
	auto conv2D_1 = network->addConvolution(
	    *concat->getOutput(0),
	    32,
	    DimsHW{3, 3},
	    weights.at("conv2D_1_k"),
	    weights.at("conv2D_1_b")
	);
	...
	auto conv2D_2 = network->addConvolution(
	    *conv2D_1_act->getOutput(0),
	    32,
	    DimsHW{3, 3},
	    weights.at("conv2D_2_k"),
	    weights.at("conv2D_2_b")
	);
	...
	auto conv2D_3ds = network->addConvolution(
	    *conv2D_2_act->getOutput(0),
	    64,
	    DimsHW{3, 3},
	    weights.at("conv2D_3ds_k"),
	    weights.at("conv2D_3ds_b")
	);
	...
	auto conv2D_4 = network->addConvolution(
	    *conv2D_3ds_act->getOutput(0),
	    64,
	    DimsHW{3, 3},
	    weights.at("conv2D_4_k"),
	    weights.at("conv2D_4_b")
	);
	...
	auto conv2D_5 = network->addConvolution(
	    *conv2D_4_act->getOutput(0),
	    64,
	    DimsHW{3, 3},
	    weights.at("conv2D_5_k"),
	    weights.at("conv2D_5_b")
	);
	...
	auto conv2D_6ds = network->addConvolution(
	    *conv2D_5_act->getOutput(0),
	    128,
	    DimsHW{3, 3},
	    weights.at("conv2D_6ds_k"),
	    weights.at("conv2D_6ds_b")
	);
	...
	auto conv2D_7 = network->addConvolution(
	    *conv2D_6ds_act->getOutput(0),
	    128,
	    DimsHW{3, 3},
	    weights.at("conv2D_7_k"),
	    weights.at("conv2D_7_b")
	);
	...
	auto conv2D_8 = network->addConvolution(
	    *conv2D_7_act->getOutput(0),
	    128,
	    DimsHW{3, 3},
	    weights.at("conv2D_8_k"),
	    weights.at("conv2D_8_b")
	);
	...
	auto deconv2D_1 = network->addDeconvolution(
	    *conv2D_8_act->getOutput(0),
	    64,
	    DimsHW{3, 3},
	    weights.at("deconv2D_1_k"),
	    weights.at("deconv2D_1_b")
	);
	...
	auto deconv2D_1_act = addElu(
	    plugin_factory,
	    *network,
	    *deconv2D_1_add_skip->getOutput(0),
	    data_type,
	    "deconv2D_1_act"
	);
	...
	auto deconv2D_2 = network->addDeconvolution(
	    *deconv2D_1_act->getOutput(0),
	    32,
	    DimsHW{3, 3},
	    weights.at("deconv2D_2_k"),
	    weights.at("deconv2D_2_b")
	);
	...
	auto deconv2D_2_act = addElu(
	    plugin_factory,
	    *network,
	    *deconv2D_2_add_skip->getOutput(0),
	    data_type,
	    "deconv2D_2_act"
	);
	...
	auto deconv2D_3 = network->addDeconvolution(
	    *deconv2D_2_act->getOutput(0),
	    1,
	    DimsHW{3, 3},
	    weights.at("deconv2D_3_k"),
	    weights.at("deconv2D_3_b")
	);
