...
#include <NvInfer.h>
	...
	// -----------------------------------------------------------------
	enum class Conv3DType { kCuDnn = 0, kTensorFlow = 1 };
	...
	public:
		...
		// Cost volume plugin.
		virtual IPlugin* createCostVolumePlugin(
		    DataType data_type,
		...
		// 3D convolution.
		virtual IPlugin* createConv3DPlugin(
		...
		virtual IPlugin* createConv3DTransposePlugin(
		    Conv3DType conv_type,
		    Dims kernel_dims,
		    Dims out_dims,
		    Dims stride_dims,
	...
	public:
		enum class PluginType { kElu = 0, kCostVolume = 1, kSoftargmax = 2 };
