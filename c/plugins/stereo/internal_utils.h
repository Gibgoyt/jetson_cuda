...
#include "redtail_tensorrt_plugins.h"
	...
	public:
		template <typename T>
		static cudaError_t computeCostVolume(
		    DataType data_type,
		    const T* left,
		    const T* right,
		    Dims in_dims,
		...
		template <typename T>
		static cudaError_t computeCorrCostVolume(
		    DataType data_type,
		    const T* left,
		    const T* right,
		    Dims in_dims,
	...
	public:
		...
		// Cost volume plugin.
		IPlugin* createCostVolumePlugin(
		    DataType data_type,
		...
		IPlugin* createConv3DTransposePlugin(
		    Conv3DType conv_type,
		    Dims kernel_dims,
		    Dims out_dims,
		    Dims stride_dims,
