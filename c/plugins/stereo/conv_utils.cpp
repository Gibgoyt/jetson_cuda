...
void ConvUtils::setConv3DTensorDescriptor(
...
void ConvUtils::setConv3DOperationDescriptors(
    Conv3DType conv_type,
    Dims w_dims,
    Dims stride_dims,
    Dims pad_dims,
...
Dims ConvUtils::getConv3DOutputDims(
    cudnnConvolutionDescriptor_t c_desc,
	...
	y_dims.nbDims = 5;
	CHECKL(
	    cudnnGetConvolutionNdForwardOutputDim(c_desc, x_desc, w_desc, y_dims.nbDims, y_dims.d),
	    log
	);
	return y_dims;
}

void ConvUtils::setConv3DBiasDescriptor(
    Dims dims,
    cudnnDataType_t data_type,
    cudnnTensorDescriptor_t& desc,
    ILogger& log
	...
	std::array<int, 5> strides = {
	    dims.d[1] * dims.d[2] * dims.d[3] * dims.d[4],
