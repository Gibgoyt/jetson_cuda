...
#define CHECK(status)                                                                              \
	...
	public:
		...
		const char* getPluginType() const override { return "Slice"; }

		const char* getPluginVersion() const override { return "1"; }

		void destroy() override { delete this; }

		IPluginV2* clone() const override { return new StridedSlicePlugin(0, 0, 0); }
	...
	public:
		...
		const char* getPluginName() const override { return "Slice"; }
