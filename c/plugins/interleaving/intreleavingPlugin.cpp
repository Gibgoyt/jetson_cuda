...
int InterleavingPlugin::enqueue(
    int batchSize,
...
IPluginV2*
InterleavingPluginCreator::createPlugin(const char* name, const PluginFieldCollection* fc) {
