...
void paf_score_graph_out_hw(
    float* score_graph,  // MxM
...
void paf_score_graph_out_khw(
    float* score_graph,   // KxMxM
...
void paf_score_graph_out_nkhw(
    float* score_graph,   // NxKxMxM
    const int* topology,  // Kx4
