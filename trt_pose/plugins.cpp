...
std::vector<torch::Tensor> find_peaks_torch(
    torch::Tensor input,
    const float threshold,
    const int window_size,
    const int max_count
...
void refine_peaks_out_torch(
    torch::Tensor refined_peaks,
    torch::Tensor counts,
    torch::Tensor peaks,
    torch::Tensor cmap,
    int window_size
...
void paf_score_graph_out_torch(
...
torch::Tensor paf_score_graph_torch(
    torch::Tensor paf,
    torch::Tensor topology,
    torch::Tensor counts,
    torch::Tensor peaks,
...
void connect_parts_out_torch(
    torch::Tensor object_counts,
...
std::vector<torch::Tensor> connect_parts_torch(
    torch::Tensor connections,
    torch::Tensor topology,
    torch::Tensor counts,
    int max_count
