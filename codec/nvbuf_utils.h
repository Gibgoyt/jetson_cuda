...
#define NVBUF_CHROMA_SUBSAMPLING_PARAMS_DEFAULT                                                    \
	 ...
	 * @returns 0 for success, -1 for failure.
	 */
	int NvBufferMemSyncForDeviceEx(
	    int dmabuf_fd,
	    NvBufferParamsEx* exparams,
	    unsigned int plane,
	    void** pVirtAddr
